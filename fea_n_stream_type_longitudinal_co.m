...
ntu=[2 0 -2]' ; %zeros(n,1);           % this matrix initialises the NTU values of all the streams

boundry_constant=[297 0 87]' ; %zeros(n,1);     % This matrix initialisrs the boundry conditions specified in the problem
% for i=1:n
