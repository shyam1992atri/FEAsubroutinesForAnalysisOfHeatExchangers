function analatic_theta

e=input('specify the number of elements');
s=zeros(4,8);
s(1,1)=-530*11+(110*3)/(2*e)+(42*3)/(2*e)+(28*3)/(2*e);
s(1,5)=530*11+(110*3)/(2*e)+(3*42)/(2*e)+(28*3)/(2*e);
s(1,2)=-(110*3)/(2*e);
s(1,6)=-(110*3)/(2*e);
s(1,3)=-(42*3)/(2*e);
s(1,7)=-(42*3)/(2*e);
...
s(2,1)=-(110*3)/(2*e);
s(2,5)=-(110*3)/(2*e);
s(2,2)=1100*11+(110*3)/(2*e)+(131*3)/(2*e)+(18*3)/(2*e);
s(2,6)=-1100*11+(110*3)/(2*e)+(131*3)/(2*e)+(18*3)/(2*e);
s(2,3)=-(131*3)/(2*e);
s(2,7)=-(131*3)/(2*e);
s(2,4)=-(18*3)/(2*e);
s(2,8)=-(18*3)/(2*e);
...
s(3,2)=-(131*3)/(2*e);
s(3,6)=-(131*3)/(2*e);
s(3,3)=-378*11+(42*3)/(2*e)+(131*3)/(2*e)+(46*3)/(2*e);
s(3,7)=378*11+(42*3)/(2*e)+(131*3)/(2*e)+(46*3)/(2*e);
s(3,4)=-(46*3)/(2*e);
s(3,8)=-(46*3)/(2*e);
...
s(4,3)=-(46*3)/(2*e);
s(4,7)=-(46*3)/(2*e);
s(4,4)=684*11+(28*3)/(2*e)+(18*3)/(2*e)+(46*3)/(2*e);
s(4,8)=-684*11+(28*3)/(2*e)+(18*3)/(2*e)+(46*3)/(2*e);
s;
k=0;
if e==1
...
if e>1
    ...
    constant=[zeros((4*e),1);1;-12/11;0;-28/33];
    solution=inv(global_stifnes)*constant;
end
