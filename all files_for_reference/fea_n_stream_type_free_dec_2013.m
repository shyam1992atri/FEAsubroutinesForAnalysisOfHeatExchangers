...
% This program works of finite element analysis
...
n=input('specify the number of streams:');
...
s=zeros(n,2*n);          % initializing the coefficient matrix generated from the differential equations
...
mf=zeros(n,1);           % this matrix initializes the m.cp values of all the streams
...
for d=1:1:n             % loop to control the rows of UA
    ...
    fprintf('boundary temperatures in the problem of stream %d',d)
