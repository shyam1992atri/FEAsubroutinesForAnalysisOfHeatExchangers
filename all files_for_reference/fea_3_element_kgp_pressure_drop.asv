function fea_3_element_kgp_pressure_drop
...
mf=[-748.874;457.73;-174.765];           % this matrix initialises the m.cp values of all the streams
boundry_constant=[180;300;170];     % This matrix initialisrs the boundry conditions specified in the problem
h=[163 116 94];
fin_hight=[0.019 0.019 0.01];
fin_freq=[118.5 78.74 244.1];
alfa=[0.5 0.5 0.5];%zeros(1,n)
aw=0.5*1;   %length=1meter bredth=0.5 meter
af=zeros(1,n);
mdot=[0.718 0.191 0.455];  %this array gives mass flow rate values
fin_thick=[0.813e-3 0.254e-3 0.813e-3];
