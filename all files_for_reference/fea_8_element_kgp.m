...
mf=[457.73;-174.76;-641.64;575.54;328.18;-748.87;928.53;-211.05];           % this matrix initialises the m.cp values of all the streams

boundry_constant=[300;170;140;320;350;180;400;160];     % This matrix initialisrs the boundry conditions specified in the problem
h=[116 94 116 94 126 163 126 94];
fin_hight=[0.019 0.01 0.019 0.01 0.019 0.019 0.019 0.01];
fin_freq=[78.74 244.1 78.74 244.1 78.74 118.5 78.74 244.1];
alfa=[0.05 0.00001 0.05 0.00001 0.1 0.001 0.0001 0.0001];
