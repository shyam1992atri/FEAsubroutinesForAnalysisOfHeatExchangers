...
mf=[-147.51;457.73;-183.92;758.58;-748.87;518.13;-174.765];           % this matrix initialises the m.cp values of all the streams

boundry_constant=[160;300;140;320;180;350;170];     % This matrix initialisrs the boundry conditions specified in the problem
h=[94 116 94 116 163 116 94];
fin_hight=[0.01 0.019 0.01 0.019 0.019 0.019 0.01];
fin_freq=[244.1 78.74 244.1 78.74 118.5 78.74 244.1];
alfa=[0.0001 0.1 0.05 0.01 0.1 0.001 0.0001];
